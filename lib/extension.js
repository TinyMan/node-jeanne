...
const playstream = {
    ...
    exec: function playstream(data) {
        if (this.io.input) return false;
            ...
            const ffmpeg_proc = ffmpeg(data.stream)
            ...
            pass
                ...
                .on('kill', () => {
                    ...
                    ffmpeg_proc.kill('SIGTERM');
                })
                .pipe(this.io.input);
            ffmpeg_proc.pipe(pass)
...
module.exports = {
    ...
    commands: [radio, youtube, ytstop, ytnext, add, addnext, search, monte, baisse, pause, resume, clearBuffer, reboot]
};
